...
public class Constants {
    ...
    public static final String CONTENT_PARTNER_REGISTRATION_INDEX_NAME = "content_provider_registration_alias";
    ...
    public static final String API_PARTNER_ACTIVATE = "api.partner.activate";
